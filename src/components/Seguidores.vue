...
export default {
  ...
  //       phone: follower.follower.phone_number,
  //       gender: follower.follower.profile.gender,
  //       avatar: follower.follower.profile.picture
  //     };
  //     this.users.push(new_follower);
  //   }
  // },
  ...
  methods: {
    ...
    //   return item.children.push(this.profileData.followers);
